    ...
    return {
      ...
      body: {
        ...
        ...(alternative ? { suggestion: {
          sku: alternative.sku, name: alternative.name, available: alternative.available
        } } : {})
      }
    };
  }
